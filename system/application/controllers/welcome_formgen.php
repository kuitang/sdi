...
class Welcome extends Controller {
	...
	function index()
	{
		...
		->text('name', 'Your Name', 'required|max_length[40]', 'Hans')
		...
		// this textarea has some default text
		...
		->checkbox('privacy', 'yes', 'I agree to the <a href="#">privacy policy</a>', FALSE, 'required')
		->space()
